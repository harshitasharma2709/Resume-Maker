...
const Features = () => {
  ...
  return (
    ...
    <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 rounded-full px-6 py-1.5">
        ...
        <Title title='Build your dream resume' description='Create a professional resume in minutes with our easy-to-use builder.' />
                    ...
                    <div className={"flex items-center justify-center gap-6 max-w-md group cursor-pointer"}>
                            <div className={`p-6 group-hover:bg-violet-100 border border-transparent group-hover:border-violet-300  flex gap-4 rounded-xl transition-colors ${!isHover ? 'border-violet-300 bg-violet-100' : ''}`}>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-slate-600 max-w-xs">Let AI suggest professional phrases, bullet points, and summaries tailored to your job role.</p>
                                </div>
                            </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                            <div className="p-6 group-hover:bg-green-100 border border-transparent group-hover:border-green-300 flex gap-4 rounded-xl transition-colors">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-slate-600 max-w-xs">Choose from a library of ATS-friendly templates designed to impress recruiters at top companies.</p>
                                </div>
                            </div>
                    </div>
                    <div className="flex items-center justify-center gap-6 max-w-md group cursor-pointer">
                            <div className="p-6 group-hover:bg-orange-100 border border-transparent group-hover:border-orange-300 flex gap-4 rounded-xl transition-colors">
                                ...
                                <div className="space-y-2">
                                    <h3 className="text-base font-semibold text-slate-700">One-Click PDF Export</h3>
                                    <p className="text-sm text-slate-600 max-w-xs">Download your polished resume as a pixel-perfect PDF, ready to send to employers instantly.</p>
                                </div>
                            </div>
                    </div>
                </div>
